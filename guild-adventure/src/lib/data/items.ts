...
export const raceTreasures: ItemData[] = [
  { id: 'treasure_human', name: '人間の秘宝', description: '人間のキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'human' },
  { id: 'treasure_elf', name: 'エルフの秘宝', description: 'エルフのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'elf' },
  { id: 'treasure_dwarf', name: 'ドワーフの秘宝', description: 'ドワーフのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'dwarf' },
  { id: 'treasure_halfling', name: 'ハーフリングの秘宝', description: 'ハーフリングのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'halfling' },
  { id: 'treasure_orc', name: 'オークの秘宝', description: 'オークのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'orc' },
  { id: 'treasure_lizardman', name: 'リザードマンの秘宝', description: 'リザードマンのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'lizardman' },
  { id: 'treasure_fairy', name: 'フェアリーの秘宝', description: 'フェアリーのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'fairy' },
  { id: 'treasure_undead', name: 'アンデッドの秘宝', description: 'アンデッドのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'undead' },
  { id: 'treasure_goblin', name: 'ゴブリンの秘宝', description: 'ゴブリンのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'goblin' },
  { id: 'treasure_dragonewt', name: 'ドラゴニュートの秘宝', description: 'ドラゴニュートのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'dragonewt' },
  { id: 'treasure_angel', name: 'エンジェルの秘宝', description: 'エンジェルのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'angel' },
  { id: 'treasure_demon', name: 'デーモンの秘宝', description: 'デーモンのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'demon' },
  { id: 'treasure_genasi', name: 'ジェナシの秘宝', description: 'ジェナシのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'genasi' },
  { id: 'treasure_aasimar', name: 'アアシマールの秘宝', description: 'アアシマールのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'aasimar' },
  { id: 'treasure_tiefling', name: 'ティーフリングの秘宝', description: 'ティーフリングのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'tiefling' },
  { id: 'treasure_dhampir', name: 'ダンピールの秘宝', description: 'ダンピールのキャラに使うと全ステ+10', type: 'raceTreasure', rarity: 'rare', unlocks: 'dhampir' },
];

// 職業秘宝（全20職業）- 全ステ+10
export const jobTreasures: ItemData[] = [
  { id: 'treasure_warrior', name: '戦士の秘宝', description: '戦士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'warrior' },
  { id: 'treasure_mage', name: '魔法使いの秘宝', description: '魔法使いのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'mage' },
  { id: 'treasure_priest', name: '司祭の秘宝', description: '司祭のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'priest' },
  { id: 'treasure_thief', name: '盗賊の秘宝', description: '盗賊のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'thief' },
  { id: 'treasure_knight', name: '騎士の秘宝', description: '騎士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'knight' },
  { id: 'treasure_hunter', name: '狩人の秘宝', description: '狩人のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'hunter' },
  { id: 'treasure_ninja', name: '忍者の秘宝', description: '忍者のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'ninja' },
  { id: 'treasure_sage', name: '賢者の秘宝', description: '賢者のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'sage' },
  { id: 'treasure_berserker', name: 'バーサーカーの秘宝', description: 'バーサーカーのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'berserker' },
  { id: 'treasure_paladin', name: 'パラディンの秘宝', description: 'パラディンのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'paladin' },
  { id: 'treasure_necromancer', name: 'ネクロマンサーの秘宝', description: 'ネクロマンサーのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'necromancer' },
  { id: 'treasure_monk', name: 'モンクの秘宝', description: 'モンクのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'monk' },
  { id: 'treasure_ranger', name: 'レンジャーの秘宝', description: 'レンジャーのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'ranger' },
  { id: 'treasure_samurai', name: 'サムライの秘宝', description: 'サムライのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'samurai' },
  { id: 'treasure_witch', name: 'ウィッチの秘宝', description: 'ウィッチのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'witch' },
  { id: 'treasure_bard', name: 'バードの秘宝', description: 'バードのキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'bard' },
  { id: 'treasure_spellblade', name: '魔法剣士の秘宝', description: '魔法剣士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'spellblade' },
  { id: 'treasure_battlemage', name: '戦闘魔導士の秘宝', description: '戦闘魔導士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'battlemage' },
  { id: 'treasure_runesmith', name: '符術士の秘宝', description: '符術士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'runesmith' },
  { id: 'treasure_redmage', name: '赤魔道士の秘宝', description: '赤魔道士のキャラに使うと全ステ+10', type: 'jobTreasure', rarity: 'rare', unlocks: 'redmage' },
];
