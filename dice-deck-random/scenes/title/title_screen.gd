...
[b]■ 先攻・後攻ルール[/b]
・先攻1ターン目: ダイスなし、ドローなし
・[color=yellow]後攻1ターン目: +1マナボーナス[/color]
...
[b]■ カード効果[/b]
・[color=cyan]召喚時[/color]: 召喚した瞬間に発動
・[color=orange]攻撃時[/color]: 攻撃が命中した時に発動
・[color=red]死亡時[/color]: 撃破された時に発動
・[color=yellow]常時[/color]: フィールドにいる間、常に効果が適用
