...
func _generate_card_pool() -> void:
	...
	var blue_defs := [
		# Cost 1 (7-2=5)
		[20, "氷の精霊", 1, 2, 2, [1,2], "blue_001"],
		[21, "フロストバット", 1, 1, 4, [1], "blue_002"],
		[22, "氷のネズミ", 1, 3, 1, [2], "blue_009"],
		[23, "霜の妖精", 1, 4, 1, [6], "blue_001"],
		# Cost 2 (10-2=8)
		[24, "水の使い", 2, 1, 6, [2,3], "blue_001"],
		[25, "霧の狼", 2, 2, 2, [1,2,3,4], "blue_003"],
		[26, "氷の彫刻家", 2, 3, 3, [1,3], "blue_011"],
		[27, "海のスライム", 2, 5, 2, [5,6], "blue_010"],
		# Cost 3 (13-3=10)
		[28, "氷結の騎士", 3, 2, 7, [1,2], "blue_004"],
		[29, "深海魚", 3, 3, 4, [1,2,3,4], "blue_005"],
		[30, "吹雪の魔術師", 3, 4, 4, [2,3], "blue_003"],
		[31, "氷の壁", 3, 7, 3, [3,6], "blue_013"],
		# Cost 4 (16-3=13)
		[32, "吹雪のドラゴン", 4, 2, 9, [1,2,3], "blue_004"],
		[33, "海神の守護者", 4, 4, 5, [1,2,3,4], "blue_006"],
		[34, "海賊船長", 4, 6, 4, [2,4,6], "blue_014"],
		[35, "北風の精", 4, 8, 4, [3,6], "blue_015"],
		# Cost 5 (19-4=15)
		[36, "氷帝", 5, 3, 11, [1,2], "blue_007"],
		[37, "凍てつく巨人", 5, 4, 7, [1,2,3,4,5], "blue_008"],
		[38, "氷山", 5, 7, 6, [2,4,6], "blue_016"],
		[39, "絶対零度", 5, 9, 5, [3,6], "blue_018"],
	]
	...
	var green_defs := [
		# Cost 1 (7-2=5)
		[40, "森の妖精", 1, 2, 2, [1,2], "green_001"],
		[41, "若木のトレント", 1, 1, 4, [1], "green_002"],
		[42, "花のスプライト", 1, 3, 1, [2], "green_001"],
		[43, "種まき", 1, 4, 1, [6], "green_002"],
		# Cost 2 (10-2=8)
		[44, "草原の狩人", 2, 1, 6, [2,3], "green_001"],
		[45, "花の精", 2, 2, 2, [1,2,3,4], "green_003"],
		[46, "蔦の魔術師", 2, 3, 3, [1,3], "green_001"],
		[47, "木こりオーク", 2, 5, 2, [5,6], "green_010"],
		# Cost 3 (13-3=10)
		[48, "森の守護者", 3, 2, 7, [1,2], "green_004"],
		[49, "大樹の戦士", 3, 3, 4, [1,2,3,4], "green_005"],
		[50, "ドリアードの巫女", 3, 4, 4, [2,3], "green_011"],
		[51, "森の巨人", 3, 7, 3, [3,6], "green_012"],
		# Cost 4 (16-3=13)
		[52, "エルフの賢者", 4, 2, 9, [1,2,3], "green_006"],
		[53, "古代樹", 4, 4, 5, [1,2,3,4], "green_007"],
		[54, "春風の使者", 4, 6, 4, [2,4,6], "green_013"],
		[55, "苔の巨人", 4, 8, 4, [3,6], "green_014"],
		# Cost 5 (19-4=15)
		[56, "森林王", 5, 3, 11, [1,2], "green_008"],
		[57, "世界樹の化身", 5, 4, 7, [1,2,3,4,5], "green_009"],
		[58, "大地の精霊", 5, 7, 6, [2,4,6], "green_015"],
		[59, "生命の木", 5, 9, 5, [3,6], "green_016"],
	]
	...
	var black_defs := [
		# Cost 1 (7-2+selfdam)
		[60, "闇のコウモリ", 1, 2, 2, [1,2], "black_001"],
		[61, "呪いの人形", 1, 1, 4, [1], "black_002"],
		[62, "疫病ネズミ", 1, 3, 1, [2], "black_010"],
		[63, "闇のインプ", 1, 4, 1, [6], "black_001"],
		# Cost 2 (10-2+selfdam)
		[64, "影の暗殺者", 2, 1, 6, [2,3], "black_003"],
		[65, "毒蛇", 2, 2, 2, [1,2,3,4], "black_004"],
		[66, "ゾンビ", 2, 3, 3, [1,3], "black_011"],
		[67, "闇の魔術師", 2, 5, 2, [5,6], "black_012"],
		# Cost 3 (13-3+selfdam)
		[68, "堕天使", 3, 2, 7, [1,2], "black_005"],
		[69, "死霊術師", 3, 3, 4, [1,2,3,4], "black_006"],
		[70, "骸骨剣士", 3, 4, 4, [2,3], "black_013"],
		[71, "悪魔の契約者", 3, 7, 3, [3,6], "black_014"],
		# Cost 4 (16-3+selfdam)
		[72, "漆黒の騎士", 4, 2, 9, [1,2,3], "black_005"],
		[73, "吸血鬼", 4, 4, 5, [1,2,3,4], "black_007"],
		[74, "ダークナイト", 4, 6, 4, [2,4,6], "black_015"],
		[75, "死神", 4, 8, 4, [3,6], "black_016"],
		# Cost 5 (19-4+selfdam)
		[76, "魔王の影", 5, 3, 11, [1,2], "black_008"],
		[77, "深淵の王", 5, 4, 7, [1,2,3,4,5], "black_009"],
		[78, "堕落の竜", 5, 7, 6, [2,4,6], "black_017"],
		[79, "暗黒神", 5, 9, 5, [3,6], "black_019"],
	]
	...
	# ═══════════════════════════════════════════
	var red_defs := [
		[80, "火の精霊", 1, 2, 2, [1,2], "red_001"],
		[81, "炎のネズミ", 1, 1, 4, [1], "red_002"],
		[82, "火花インプ", 1, 3, 1, [2], "red_001"],
		[83, "溶岩スライム", 1, 4, 1, [6], "red_003"],
		[84, "炎の戦士", 2, 1, 6, [2,3], "red_001"],
		[85, "火炎魔術師", 2, 2, 2, [1,2,3,4], "red_004"],
		[86, "バーニングナイト", 2, 3, 3, [1,3], "red_005"],
		[87, "火の鳥", 2, 5, 2, [5,6], "red_006"],
		[88, "炎の騎士", 3, 2, 7, [1,2], "red_007"],
		[89, "ファイアドラゴン", 3, 3, 4, [1,2,3,4], "red_008"],
		[90, "溶岩巨人", 3, 4, 4, [2,3], "red_009"],
		[91, "業火の魔人", 3, 7, 3, [3,6], "red_010"],
		[92, "炎帝", 4, 2, 9, [1,2,3], "red_011"],
		[93, "フェニックス", 4, 4, 5, [1,2,3,4], "red_012"],
		[94, "地獄の番犬", 4, 6, 4, [2,4,6], "red_013"],
		[95, "火山龍", 4, 8, 4, [3,6], "red_014"],
		[96, "炎神", 5, 3, 11, [1,2], "red_015"],
		[97, "メテオドラゴン", 5, 4, 7, [1,2,3,4,5], "red_016"],
		[98, "灼熱の魔王", 5, 7, 6, [2,4,6], "red_017"],
		[99, "太陽神", 5, 9, 5, [3,6], "red_018"],
	]
	...
	# ═══════════════════════════════════════════
	var yellow_defs := [
		[100, "光の精霊", 1, 2, 2, [1,2], "yellow_001"],
		[101, "聖なる小鳥", 1, 1, 4, [1], "yellow_002"],
		[102, "祝福のスプライト", 1, 3, 1, [2], "yellow_003"],
		[103, "星の欠片", 1, 4, 1, [6], "yellow_004"],
		[104, "光の戦士", 2, 1, 6, [2,3], "yellow_005"],
		[105, "癒しの天使", 2, 2, 2, [1,2,3,4], "yellow_006"],
		[106, "守護の騎士", 2, 3, 3, [1,3], "yellow_007"],
		[107, "光のスライム", 2, 5, 2, [5,6], "yellow_008"],
		[108, "聖騎士", 3, 2, 7, [1,2], "yellow_009"],
		[109, "光の魔術師", 3, 3, 4, [1,2,3,4], "yellow_010"],
		[110, "天使", 3, 4, 4, [2,3], "yellow_011"],
		[111, "希望の使者", 3, 7, 3, [3,6], "yellow_012"],
		[112, "大天使", 4, 2, 9, [1,2,3], "yellow_013"],
		[113, "光の龍", 4, 4, 5, [1,2,3,4], "yellow_014"],
		[114, "聖者", 4, 6, 4, [2,4,6], "yellow_015"],
		[115, "祝福の精霊王", 4, 8, 4, [3,6], "yellow_016"],
		[116, "光神", 5, 3, 11, [1,2], "yellow_017"],
		[117, "天空龍", 5, 4, 7, [1,2,3,4,5], "yellow_018"],
		[118, "希望の女神", 5, 7, 6, [2,4,6], "yellow_019"],
		[119, "太陽の化身", 5, 9, 5, [3,6], "yellow_020"],
	]
	...
	# ═══════════════════════════════════════════
	var purple_defs := [
		[120, "闇の精霊", 1, 2, 2, [1,2], "purple_001"],
		[121, "呪いのコウモリ", 1, 1, 4, [1], "purple_002"],
		[122, "影のネズミ", 1, 3, 1, [2], "purple_003"],
		[123, "夜の蝶", 1, 4, 1, [6], "purple_004"],
		[124, "闇の魔術師", 2, 1, 6, [2,3], "purple_005"],
		[125, "呪術師", 2, 2, 2, [1,2,3,4], "purple_006"],
		[126, "影の狼", 2, 3, 3, [1,3], "purple_007"],
		[127, "夢魔", 2, 5, 2, [5,6], "purple_008"],
		[128, "闇の騎士", 3, 2, 7, [1,2], "purple_009"],
		[129, "呪いの魔女", 3, 3, 4, [1,2,3,4], "purple_010"],
		[130, "影の龍", 3, 4, 4, [2,3], "purple_011"],
		[131, "悪夢の使者", 3, 7, 3, [3,6], "purple_012"],
		[132, "闇の王", 4, 2, 9, [1,2,3], "purple_013"],
		[133, "呪いの竜", 4, 4, 5, [1,2,3,4], "purple_014"],
		[134, "影の支配者", 4, 6, 4, [2,4,6], "purple_015"],
		[135, "悪夢の王", 4, 8, 4, [3,6], "purple_016"],
		[136, "闇神", 5, 3, 11, [1,2], "purple_017"],
		[137, "呪いの神", 5, 4, 7, [1,2,3,4,5], "purple_018"],
		[138, "影の帝王", 5, 7, 6, [2,4,6], "purple_019"],
		[139, "虚無の王", 5, 9, 5, [3,6], "purple_020"],
	]
	...
	# ═══════════════════════════════════════════
	var white_defs := [
		[140, "聖なる精霊", 1, 2, 2, [1,2], "white_001"],
		[141, "癒しの光", 1, 1, 4, [1], "white_002"],
		[142, "守護の精霊", 1, 3, 1, [2], "white_003"],
		[143, "祈りの天使", 1, 4, 1, [6], "white_004"],
		[144, "白の戦士", 2, 1, 6, [2,3], "white_005"],
		[145, "癒しの騎士", 2, 2, 2, [1,2,3,4], "white_006"],
		[146, "聖なる盾", 2, 3, 3, [1,3], "white_007"],
		[147, "祝福の僧侶", 2, 5, 2, [5,6], "white_008"],
		[148, "聖騎士団長", 3, 2, 7, [1,2], "white_009"],
		[149, "癒しの天使長", 3, 3, 4, [1,2,3,4], "white_010"],
		[150, "聖なる守護者", 3, 4, 4, [2,3], "white_011"],
		[151, "祈りの巫女", 3, 7, 3, [3,6], "white_012"],
		[152, "大聖騎士", 4, 2, 9, [1,2,3], "white_013"],
		[153, "神聖龍", 4, 4, 5, [1,2,3,4], "white_014"],
		[154, "復活の天使", 4, 6, 4, [2,4,6], "white_015"],
		[155, "聖域の守護者", 4, 8, 4, [3,6], "white_016"],
		[156, "聖神", 5, 3, 11, [1,2], "white_017"],
		[157, "神聖の化身", 5, 4, 7, [1,2,3,4,5], "white_018"],
		[158, "復活の女神", 5, 7, 6, [2,4,6], "white_019"],
		[159, "光の創造主", 5, 9, 5, [3,6], "white_020"],
	]
